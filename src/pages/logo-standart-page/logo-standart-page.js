import styles from "./logo-standart-page.module.css";
...
export default function LogoStandartPage() {
  return (
    <main className={styles.main}>
      <div className={styles.logo_standart__text_container}>
        <h1>Стандартный логотип</h1>
      </div>
      <div className={styles.logo_section}>
        <h2>Ру версия</h2>
        <div className={styles.logo_section__img_contaner}>
          <LazyLoadImage
            src={`./logo/RGB/PNG/Parus_logo_RGB_cobalt_RUS.png`}
            alt="Логотип РУ"
            effect="blur"
            width="100%"
            height="100%"
        ...
        <div className={styles.download_section__wrappers}>
          ...
          <div className={styles.scheme_section}>
            ...
            <div className={styles.download_special_section}>
              <LazyLoadImage
                src={`./logo/RGB/PNG/Parus_logo_RGB_white_cobalt_graphite_RUS.png`}
                alt="Логотип РУ"
                effect="blur"
                width={150}
                height={100}
            ...
            <div className={styles.download_special_section}>
              <LazyLoadImage
                src={`./logo/RGB/PNG/Parus_logo_RGB_white_cobalt_RUS.png`}
                alt="Логотип РУ"
                effect="blur"
                width={150}
                height={100}
      ...
      <div className={styles.logo_section}>
        ...
        <div className={styles.logo_section__img_contaner}>
          <LazyLoadImage
            src={`./logo/RGB/PNG/Parus_logo_RGB_cobalt_ENG.png`}
            alt="Логотип En"
            effect="blur"
            width="100%"
            height="100%"
